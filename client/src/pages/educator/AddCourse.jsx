...
const AddCourse = () => {
  ...
  width={14}
  alt=""
  onClick={() => handleChapter("toggle", chapter.chapterId)}   // ✅ Toggle chapter
...
/>
  ...
  alt=""
  onClick={() => handleChapter("remove", chapter.chapterId)}   // ✅ Remove chapter
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
                  ...
                  <div className='mb-2'>
                    ...
                    <button  type='button' className="w-full bg-blue-400 text-white px-4 py-2 rounded" onClick={addLecture}>Add
